...
export default function Home() {
  ...
  const handleSubmit = async(e:any) => {
    ...
    try {
      ...
      const res = await axios.post(" http://localhost:3009/api/auth/register", data,{withCredentials:true})
      
      console.log(res)

      if(res.data.success === true){
        navigate.push("/dashboard/verify-user")
      }
  ...
  return (
    <div className="flex justify-center items-center min-h-screen">
      <div className=" border p-8 rounded-2xl">
       <div className="text-4xl font-bold p-3">Register the new Users...</div> 
